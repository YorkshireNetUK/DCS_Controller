...
apt install -y python3 python3-pip python3-venv apache2 libapache2-mod-php portaudio19-dev alsa-utils git libblas-dev liblapack-dev python3-dev gfortran python3-numpy python3-scipy libopenblas0-serial libopenblas-serial-dev
